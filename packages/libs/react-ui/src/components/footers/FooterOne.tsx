...
const FooterOne = ({ colors, socials }: FooterProps) => {
  return (
    <div
      className={`px-4 py-4 md:py-6 md:flex md:items-center md:justify-between border-t-0 ${colors.text} ${colors.border} ${colors.bg}`}
    >
