export const gmail_draft = {
  // "id": "FjP2GdJSCh1CeuDc",
  name: '[Mine] Gmail Drafts',
  ...
  nodes: [
    {
      ...
      id: '2aa42598-0271-4707-8800-81ece50ba704',
      name: 'Gmail Trigger',
    ...
    },
    {
      ...
      id: '49ed183f-45a6-4cf3-9517-50b59d67dda5',
      name: 'If Needs Reply',
    ...
    },
    {
      ...
      id: 'ec21f6bb-1a15-46f1-b4d5-05a45c15edbf',
      name: 'JSON Parser',
    ...
    },
    {
      ...
      id: '99c60599-53a0-486a-b9d3-70392ed8f066',
      name: 'Sticky Note',
    ...
    },
    {
      ...
      id: '01cf44ec-33c1-4ce7-a3df-2052a57adc5a',
      name: 'Sticky Note1',
      type: 'n8n-nodes-base.stickyNote',
      position: [-680, 80],
      typeVersion: 1,
    },
    {
      ...
      id: '717c3883-eec0-4a35-b800-6861136cc383',
      name: 'Sticky Note2',
      type: 'n8n-nodes-base.stickyNote',
      position: [-100, 80],
      typeVersion: 1,
    },
    {
      ...
      id: '07f87517-29e8-46c0-a650-c76d089a2ae5',
      name: 'Sticky Note3',
      type: 'n8n-nodes-base.stickyNote',
      position: [260, 80],
      typeVersion: 1,
    },
    {
      ...
      id: '0fd7239d-6e93-425e-af4f-dbc6271f585c',
      name: 'Gmail - Create Draft',
      type: 'n8n-nodes-base.gmail',
      position: [340, 160],
      typeVersion: 2.1,
      webhookId: '4877c685-88f6-4f5f-8e34-06f33c7344f6',
    },
    {
      parameters: {
        prompt:
        ...
        messages: {
          messageValues: [
            {
              message:
                "Your task is to assess if the message requires a response. Return in JSON format true if it does, false otherwise.\nMarketing emails don't require a response.",
            },
          ],
        },
      },
      id: '5e1f157f-55a2-4ec7-b191-b958290c7894',
    ...
    },
    {
      ...
      id: '998895ea-e03c-45db-9ed1-2e9192f648ef',
    ...
    },
    {
      ...
      typeVersion: 1,
      position: [-40, 360],
      id: 'd9c361ad-4f27-426a-b26b-0b10e036b864',
    ...
    },
    {
      ...
      typeVersion: 1,
      position: [-640, 360],
      id: '0b577dc1-35e4-4bfd-b28e-12c1c4facb08',
