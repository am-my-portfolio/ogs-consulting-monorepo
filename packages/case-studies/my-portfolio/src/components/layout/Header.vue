  ...
  >
    ...
    <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
      ...
      <form class="relative flex flex-1 m-1" action="#" method="GET">
        ...
        <input
          id="search-field"
          class="block h-full w-full pl-10 pr-0 text-pop-secondary placeholder:text-pop-secondary focus:ring-0 sm:text-sm bg-dull-primary border-2 border-dull-secondary/20 rounded-md"
          placeholder="Search ..."
          type="search"
          name="search"
        />
      ...
      <div class="flex items-center gap-x-4 lg:gap-x-6">
        <button
          type="button"
          class="-m-2.5 p-2.5 text-pop-secondary hover:text-dull-secondary"
        >
