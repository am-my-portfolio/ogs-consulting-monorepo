...
const logger = new Logger('Hustle Network Mealme Service');
...
export function setupSwagger(app: INestApplication) {
  const options = new DocumentBuilder()
    .setTitle('Hustle Network Technologies - MealMe Service')
    .setDescription('MealMe Service for Hustle Network Technologies')
    .setVersion('1.0')
    .addTag('')
    .addBearerAuth()
    .build();
