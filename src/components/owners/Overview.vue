        ...
        <div class="flex flex-1 flex-col p-8">
          ...
          <dl class="mt-1 flex flex-grow flex-col justify-between">
            ...
            <dd class="text-sm text-secondary">
              # of Properties: {{ person.unit_count }}
            </dd>
            <dt class="sr-only">Role</dt>
            <dd class="mt-1">
              <span
                class="inline-flex items-center rounded-full bg-pop-primary px-2 py-2 text-xs font-medium text-dull-secondary ring-1 ring-inset ring-pop-secondary/50"
                >Portfolio Value (in Millions):
                {{ person.portfolio_value }}</span
              >
            </dd>
          </dl>
        </div>
