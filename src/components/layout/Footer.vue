<template>
  <footer>
    <div
      class="px-4 py-8 md:flex md:items-center md:justify-between text-pop-primary"
    >
      <div class="flex justify-center space-x-6 md:order-2">
        <a
          ...
          :key="item.name"
          :href="item.href"
          class="hover:text-pop-secondary"
          target="_blank"
        >
...
const socials = [
  {
    name: "website",
    href: "https://wearesam.co",
    icon: "fa-solid fa-globe",
  },
  {
    name: "GitHub",
    href: "https://github.com/wearesamco????",
    icon: "fa-brands fa-github",
  },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/company/wearesamco/",
